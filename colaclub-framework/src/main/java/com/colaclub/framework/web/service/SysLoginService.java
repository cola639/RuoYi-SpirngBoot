...
public class SysLoginService {
  ...
  public String loginByOtherSource(String code, String source, String uuid) {
    ...
    System.out.println(
        "GiteeClientId GiteeClientSecret getGiteeRedirectURL "
            + thirdLogins.getGiteeClientId()
            + thirdLogins.getGiteeClientSecret()
            + thirdLogins.getGiteeRedirectURL());
