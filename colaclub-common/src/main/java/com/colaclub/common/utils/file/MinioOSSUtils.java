...
public class MinioOSSUtils {
  ...
  private static String accessPre = "http://148.135.43.239:9090/browser/dev-project/";
   ...
   * @param multipartFile 文件
   */
  public static String uploadMultipartFile(
   ...
   */
  public static void uploadFileInputStreamForBucket(
