...
public class MinioOSSUtils {
    ...
    public String putFileObject(String objectName, File file) throws Exception {
        // 判断桶是否存在
            ...
            try (FileInputStream fileInputStream = new FileInputStream(file)) {
                PutObjectArgs args =
                        PutObjectArgs.builder()
                                .bucket(bucketName)
                                .object(objectName)
                                .contentType("image/jpeg") // 假设文件类型是JPEG
...
//                            .build());
     ...
     * @throws Exception
     */
    public String putObject(String objectName, InputStream inputStream, long size, String contentType) throws Exception {
        // 判断桶是否存在
        boolean flag = existBucket(bucketName);
